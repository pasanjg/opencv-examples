...
while 1:
    ...
    if ret:
        ...
        ret, track_window = cv.meanShift(destination, track_window, term_criteria)
...
"""
Limitations:
1. Size of the target window does not change
2. Have to give the initial position of the ROI
"""
