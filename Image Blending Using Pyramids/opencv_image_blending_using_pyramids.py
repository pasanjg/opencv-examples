...
for i in range(6):  # create multiple layers of the apple image
...
for i in range(6):  # create multiple layers of the orange image
...
# add lef and right halves of the images in each level
...
cv2.imshow('AppleOrangeReconstruct', apple_orange_reconstruct)
cv2.waitKey(0)
